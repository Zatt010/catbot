...
})({"5w1gS":[function(require,module,exports) {
...
edadButton.addEventListener("click", ()=>{
    ...
    let generoSaludo = "";
    if (genero === "Masculino") {
        if (edadInput > 30) generoSaludo = "bienvenido sr";
        else generoSaludo = "bienvenido";
    } else if (genero === "Femenino") {
        if (edadInput > 30) generoSaludo = "bienvenida sra";
        else generoSaludo = "bienvenida";
    } else generoSaludo = "saludos";
    const horaActual = new Date().getHours(); // Obtiene la hora actual del sistema
    let saludoHora = "";
    if (horaActual >= 0 && horaActual < 12) saludoHora = "Buenos d\xedas";
    else if (horaActual >= 12 && horaActual < 18) saludoHora = "Buenas tardes";
    else saludoHora = "Buenas noches";
    const selectedIdioma = idiomaSelect.value;
    if (selectedIdioma === "es") mostrarSaludoCompleto(saludoHora, generoSaludo, name);
    else if (selectedIdioma === "en") mostrarSaludoIngles();
});
